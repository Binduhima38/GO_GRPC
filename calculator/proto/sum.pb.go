...
func (x *SumRequest) GetNum1() uint32 {
	if x != nil {
		return x.Num1
	}
	return 0
...
func (x *SumRequest) GetNum2() uint32 {
	if x != nil {
		return x.Num2
	}
	return 0
...
func (x *NumberRequest) GetNum() uint32 {
	if x != nil {
		return x.Num
	}
	return 0
...
func (x *NumberResponse) GetResult() uint32 {
	if x != nil {
		return x.Result
	}
	return 0
...
func (x *AverageRequest) GetNum() uint32 {
	if x != nil {
		return x.Num
	}
	return 0
...
var file_sum_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0x21, 0x0a, 0x0d, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0x28, 0x0a, 0x0e, 0x4e, 0x75, 0x6d, 0x62, 0x65,
	...
	0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0x23, 0x0a, 0x0f, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x72, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x72, 0x65, 0x73, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x6d, 0x6f, 0x68, 0x61, 0x6e, 0x6b,
	0x72, 0x69, 0x73, 0x68, 0x6e, 0x61, 0x2f, 0x67, 0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x63,
...
var file_sum_proto_goTypes = []interface{}{
	...
	(*NumberResponse)(nil),  // 3: calculator.NumberResponse
